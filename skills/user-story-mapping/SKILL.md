...
1. **Discover** (Step 0) — scan data sources cheapest-first; the issue tracker (issues + taxonomy) and `.user-story-mapping/state.json` are first-class. The scan assembles the **existing** source.
